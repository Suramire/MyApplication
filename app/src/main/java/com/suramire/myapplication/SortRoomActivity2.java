...
public class SortRoomActivity2 extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mAdapterAdd = new CommonAdapter<Ammeter>(SortRoomActivity2.this, R.layout.item_sort_add, rooms) {
        ...
        mAdapterRemove = new CommonAdapter<Ammeter>(SortRoomActivity2.this, R.layout.item_sort_romove, mTempList) {
        ...
        findViewById(R.id.button30).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MyDataBase myDataBase = new MyDataBase(SortRoomActivity2.this,"test.db",null,1);
                //保存排序
                ...
                Toast.makeText(SortRoomActivity2.this, "保存成功!", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
