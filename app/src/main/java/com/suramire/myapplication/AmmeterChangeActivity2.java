...
public class AmmeterChangeActivity2 extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mMyDataBase = new MyDataBase(AmmeterChangeActivity2.this, "test.db", null, 1);
        Cursor cursor = mMyDataBase.selectAmmeter2(roomid);
        ...
        findViewById(R.id.button7).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(AmmeterChangeActivity2.this, "保存成功", Toast.LENGTH_SHORT).show();
            }
        });
    }
