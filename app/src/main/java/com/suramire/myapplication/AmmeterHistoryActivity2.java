...
public class AmmeterHistoryActivity2 extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        final MyDataBase myDataBase = new MyDataBase(AmmeterHistoryActivity2.this, "test.db", null, 1);
                ...
                public void onUpdate(BaseAdapterHelper helper, final Ammeter item, int position) {
                    ...
                    helper.setOnClickListener(R.id.imageView53, new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            myDataBase.deleteAmHistory2(item.getId());
                            Toast.makeText(AmmeterHistoryActivity2.this, "删除成功", Toast.LENGTH_SHORT).show();
                            remove(item);
                        }
                    });
                }
